...
test("bkWatch value page gates its live graph and exposes no Shaw production evidence", async () => {
  ...
  assert.equal((html.match(/class="cap-row"/g) || []).length, 15);
  ...
  assert.match(invoicing.metrics.deliverablesCompleted.label, /4 of 8 shaw-bkWatch deliverables are ready/);
