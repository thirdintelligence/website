...
const sessionCookieName = (t) => t === "thirdi-os" ? "thirdi_os_session" : `thirdi_${t}_session`;
const csrfCookieName = (t) => t === "thirdi-os" ? "thirdi_os_csrf" : `thirdi_${t}_csrf`;
const hashEnvName = (t) => t === "thirdi-os" ? "OS_PORTAL_PASSWORD_HASH" : `${t.toUpperCase().replace(/-/g, "_")}_PORTAL_PASSWORD_HASH`;
