...
const ASSET_RELEASE = "20260721-08";
...
const MANIFEST_FILES = { portal: "portal.json", home: "home.json", projects: "projects.json", library: "library.json", aiRoadmap: "ai-roadmap.json", search: "search-index.json" };
