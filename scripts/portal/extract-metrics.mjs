...
async function main() {
  ...
  const bkwatchInvoicing = {
    ...
    asOf,
    metrics: {
      projectsActive: { count: 1, descriptor: "film", label: "shaw-bkWatch — selected demo in production" },
      deliverablesCompleted: { count: 4, descriptor: "deliverables", label: "4 of 8 shaw-bkWatch deliverables are ready" },
      hoursInvested: { hours: 20, descriptor: "hours", label: "20 hours on shaw-bkWatch — demo direction, script, storyboard, and instructions" },
    ...
    financialSummary: {
      ...
      note: "bkWatch is in the pipeline phase — no invoices yet. 20 hours are recorded on shaw-bkWatch, currently in demo production.",
    },
